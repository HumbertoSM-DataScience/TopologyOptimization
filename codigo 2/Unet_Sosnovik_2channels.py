...
class Net:
    ...
    def build(self):
        ...
        up3_1 = Conv2DTranspose(4*self.filters_init,(2,2),strides=(2, 2),padding='same')(conv3_4)
        ...
        up2_1 = Conv2DTranspose(2*self.filters_init,(2,2),strides=(2, 2),padding='same')(conv2_4)
